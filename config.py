...
def add_all_arguments(parser, train):
    ...
    if train:
        ...
        parser.add_argument('--freq_smooth_loss', type=int, default=10, help='smoothing window for loss visualization')
        parser.add_argument('--freq_save_loss', type=int, default=10, help='frequency of loss plot updates')
